...
public class Strings {
    ...
    /**
     * Returns the value of a prefixed UTF-8 String from a {@link io.netty.buffer.ByteBuf} according to the MQTT spec.
     * The UTF-8 String is prefixed with a 16-bit value which indicates the actual length of the String.
     * <p>
     ...
     * @return                                The UTF-8 String or <code>null</code> if there aren't enough bytes to
     *                                        read. This can happen if this method can not read the prefixed size of the
     *                                        String or if there are less bytes to read available than indicated by the
     *                                        prefixed 16-bit length.
    ...
    /**
     * Writes a String onto a {@link io.netty.buffer.ByteBuf}. This encodes the String according to the MQTT spc. The
     * string gets prefixed with a 16-bit value which indicates the actual length of the string
     *
    ...
    /**
     * <p>
     * This method can be used to convert a long value into a human readable byte format
     * </p>
     *
     * <p>
     * 1024 bytes = 1.00 KB
     ...
     * </p>
     * <p>
     * 1024*1024*1024 bytes = 1.00 GB
     * </p>
     * <p>
     * 1024*1024*1024*1024 bytes = 1.00 TB
     * </p>
     *
