...
public final class Reflections {
    ...
    /**
     * This method is a convenient way to ask for a specific annotation on the interface method declaration.
     * <p>
     * Returns the concrete annotation for a given method from interface methods. Java does not inherit annotations form
     * interface methods to implementations, so we need to find this out by our own.
     *
    ...
    /**
     * Checks if two methods signatures are equal. In order to be considered to be equal, the following conditions must
     * be true.
     * <ul>
     ...
     * </ul>
     * In order to match, the <i>class</i> does <b>not</b> need to be equal. This allows e.g. to check for method
     * equality in interfaces and subclasses.
     *
     * @param  method
     * @param  anotherMethod
