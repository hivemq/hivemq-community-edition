...
public class EnvVarUtil {
    ...
    /**
     * Get a Java system property or system environment variable with the specified name. If a variable with the same
     * name exists in both targets the Java system property is returned.
     *
