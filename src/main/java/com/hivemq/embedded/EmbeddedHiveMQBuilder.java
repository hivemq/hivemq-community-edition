...
public interface EmbeddedHiveMQBuilder {
     ...
     * {@link com.hivemq.configuration.service.InternalConfigurations#AUTH_DENY_UNAUTHENTICATED_CONNECTIONS} to false.
     * If you do not want to start EmbeddedHiveMQ in this permissive mode, reset it to true before calling
