...
public class RetainedMessagePayloadIDMigration implements ValueMigration {
    ...
    private final @NotNull Provider<RetainedMessageXodusLocalPersistence_4_4>
            retainedMessageXodusLocalPersistence_4_4Provider;
    private final @NotNull Provider<RetainedMessageRocksDBLocalPersistence_4_4>
            retainedMessageRocksDBLocalPersistence_4_4Provider;
    ...
    public RetainedMessagePayloadIDMigration(
            final @NotNull Provider<RetainedMessageXodusLocalPersistence_4_4> retainedMessageXodusLocalPersistence_4_4Provider,
