...
public class InternalConfigurations {
     ...
     *****************/
    /**
     * The "persistence shutdown grace period" represents the time span, in which single writer tasks are still
     * processed after the persistence shutdown hook was called.
     */
    ...
    /**
     * Activates the usage of BLOB files within RocksDB for the payload persistence. default: true
     */
    public static final boolean PAYLOAD_PERSISTENCE_BLOB_ENABLED = true;
    /**
     * See {@link org.rocksdb.AdvancedMutableColumnFamilyOptionsInterface#setTargetFileSizeBase(long)} default: 1KB
     */
