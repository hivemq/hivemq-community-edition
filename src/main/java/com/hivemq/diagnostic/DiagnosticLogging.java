...
class DiagnosticLogging {
    ...
    /**
     * Sets the trace log to the root logger. Also adds filter, to make sure that the appender which are already defined
     * for HiveMQ are not affected by this logging level change.
     * <p>
     * <b>This will significantly slow down HiveMQ, since the root level loggers Level is changed to the finest logging
     * level!</b>
     *
