...
public class Mqtt5ConnectDecoder extends AbstractMqttConnectDecoder {
     ...
     * <p>
     * - response topic not UTF-8 well formed - readable bytes less than 2 - readable bytes less than indicated binary
     * length
     * <p>
     * Results in {@link Mqtt5ConnAckReasonCode#TOPIC_NAME_INVALID} with CONNACK by:
     * <p>
     ...
     * <p>
     * - readable bytes less than 2 - readable bytes less than indicated binary length
     *
     * @param  clientConnectionContext the connection of the mqtt client
     * @param  buf                     the encoded ByteBuf of the message
     ...
     * Results in {@link Mqtt5ConnAckReasonCode#MALFORMED_PACKET} with CONNACK by:
     * <p>
     * - content type not UTF-8 well formed - readable bytes less than 2 - readable bytes less than indicated binary
     * length
     *
     * @param  clientConnectionContext the connection of the mqtt client
     * @param  buf                     the encoded ByteBuf of the message
     ...
     * Results in {@link Mqtt5ConnAckReasonCode#MALFORMED_PACKET} with CONNACK by:
     * <p>
     * - payload format indicator not UTF-8 well formed - readable bytes less than 1 - readUnsignedByte() > 1 (only 0
     * and 1 are allowed)
     *
     * @param  clientConnectionContext the connection of the mqtt client
     * @param  buf                     the encoded ByteBuf of the message
