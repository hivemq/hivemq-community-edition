 ...
 */
@LazySingleton
public class Mqtt3PubcompDecoder extends MqttDecoder<PUBCOMP> {

    private static final Logger log = LoggerFactory.getLogger(Mqtt3PubcompDecoder.class);

    private final EventLog eventLog;

    @Inject
    public Mqtt3PubcompDecoder(final EventLog eventLog) {
