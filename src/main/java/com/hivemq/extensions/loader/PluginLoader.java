 ...
 * <p>
 * All extensions loaded with these PluginLoader have their <b>own classloader</b>,
 * so essentially there's an classpath isolation between all extensions.
 *
...
public interface PluginLoader {
     ...
     */
    @Nullable <T extends ExtensionMain> HiveMQPluginEvent processSinglePluginFolder(@NotNull final Path pluginFolder,
