 ...
 * @since  4.0.0
 */
public class ServerInitiatedDisconnectInputImpl implements ServerInitiatedDisconnectInput, ConnectionLostInput,
        PluginTaskInput, Supplier<ServerInitiatedDisconnectInputImpl> {
