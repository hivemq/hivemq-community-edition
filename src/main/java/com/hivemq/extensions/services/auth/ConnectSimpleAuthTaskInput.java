 ...
 */
public class ConnectSimpleAuthTaskInput extends AbstractAuthTaskInput<ConnectSimpleAuthTaskInput> implements PluginTaskInput, SimpleAuthInput {

    private final @NotNull CONNECT connect;
    private @Nullable ConnectPacketImpl connectPacket;

    public ConnectSimpleAuthTaskInput(@NotNull final CONNECT connect,
    ...
    @NotNull
    @Override
    public ConnectSimpleAuthTaskInput get() {
        return this;
    }
