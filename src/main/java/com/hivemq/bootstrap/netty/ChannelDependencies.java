...
public class ChannelDependencies {
    ...
    @Inject
    public ChannelDependencies(final @NotNull NoConnectIdleHandler noConnectIdleHandler,
            ...
            final @NotNull UnsubscribeHandler unsubscribeHandler, final @NotNull ChannelGroup channelGroup,
            final @NotNull FullConfigurationService fullConfigurationService,
            final @NotNull GlobalTrafficShapingHandler globalTrafficShapingHandler,
            final @NotNull MetricsHolder metricsHolder, final @NotNull ExceptionHandler exceptionHandler,
            ...
            final @NotNull MqttConnectDecoder mqttConnectDecoder, final @NotNull MqttConnacker mqttConnacker,
            final @NotNull EventLog eventLog, final @NotNull SslParameterHandler sslParameterHandler,
            final @NotNull MqttDecoders mqttDecoders, final @NotNull EncoderFactory encoderFactory,
