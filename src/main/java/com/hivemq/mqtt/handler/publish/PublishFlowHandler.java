...
public class PublishFlowHandler extends ChannelDuplexHandler {
    ...
    private void handlePuback(
            final @NotNull ChannelHandlerContext ctx, final PUBACK msg, @NotNull final String client) {
    ...
    private void handlePubrec(
            @NotNull final ChannelHandlerContext ctx, @NotNull final PUBREC msg, @NotNull final String client) {
    ...
    private void handlePubcomp(
            final @NotNull ChannelHandlerContext ctx, @NotNull final PUBCOMP msg, @NotNull final String client) {
