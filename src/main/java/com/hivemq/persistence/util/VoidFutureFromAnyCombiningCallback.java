 ...
 */
class VoidFutureFromAnyCombiningCallback implements FutureCallback {
    ...
    public VoidFutureFromAnyCombiningCallback(final int size, final SettableFuture<Void> resultFuture) {
        this.size = size;
