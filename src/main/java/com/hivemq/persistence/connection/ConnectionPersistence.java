...
/**
 * The ConnectionPersistence contains the connections of all the active clients. However, there is no guarantee that the
 * connection is open at the time of access. Hence, the accessing code must check
 ...
 * persisted.
 * <p>
 * The graceful shutdown of all the persisted connections can be done via {@link ConnectionPersistence#shutDown}. This
 * call is necessary when HiveMQ is shutting down.
 */
