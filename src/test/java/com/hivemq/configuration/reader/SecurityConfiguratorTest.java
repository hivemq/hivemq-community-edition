...
public class SecurityConfiguratorTest extends AbstractConfigurationTest {
    ...
    public void test_security_xml() throws Exception {
        final String contents = "<hivemq>" + "<security>" + "<utf8-validation>" + "<enabled>false</enabled>"
                + "</utf8-validation>" + "<allow-empty-client-id>" + "<enabled>false</enabled>"
                + "</allow-empty-client-id>" + "<payload-format-validation>" + "<enabled>true</enabled>"
                + "</payload-format-validation>" + "<allow-request-problem-information>" + "<enabled>false</enabled>"
                + "</allow-request-problem-information>" + "</security>" + "</hivemq>";
