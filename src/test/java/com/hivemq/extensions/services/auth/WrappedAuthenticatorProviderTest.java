...
public class WrappedAuthenticatorProviderTest {
    ...
    private final @NotNull IsolatedExtensionClassloader isolatedExtensionClassloader = IsolatedExtensionClassloaderUtil
            .buildClassLoader();
    @Test(timeout = 5000)
    public void test_null_provider_returns_null() {
        final WrappedAuthenticatorProvider wrapped = new WrappedAuthenticatorProvider((AuthenticatorProvider) i -> null,
