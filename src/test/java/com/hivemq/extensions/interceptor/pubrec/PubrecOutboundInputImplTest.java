...
public class PubrecOutboundInputImplTest {
    ...
    public void test_construction_success() {
        ...
        final PubrecOutboundInputImpl input = new PubrecOutboundInputImpl(
    ...
    public void test_client_id_null() {
        new PubrecOutboundInputImpl(null, new EmbeddedChannel(), TestMessageUtil.createSuccessPubrec());
    }

    @Test(expected = NullPointerException.class)
    public void test_channel_null() {
        new PubrecOutboundInputImpl("client", null, TestMessageUtil.createSuccessPubrec());
    }

    @Test(expected = NullPointerException.class)
    public void test_packet_null() {
        new PubrecOutboundInputImpl("client", new EmbeddedChannel(), null);
    }
    ...
    public void test_update() {
        ...
        final PubrecOutboundInputImpl input = new PubrecOutboundInputImpl("client", embeddedChannel, pubrecPacket1);
