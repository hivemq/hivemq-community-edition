...
public class ExtensionLoaderImplExtensionTest extends AbstractExtensionTest {
    ...
    private static final @NotNull String invalidExtensionXML = "<hivemq-extension>" + "<id>invalid-extension1</id>"
            + "<name>Some Name</name>" + "<version>1.2.3-Version</version>" + "<priority>1000</priority>"
            + "</hivemq-extension>";
    ...
    public void setUp() throws Exception {
        ...
        extensionLoader = new ExtensionLoaderImpl(classServiceLoader, hiveMQExtensions,
                new HiveMQExtensionFactoryImpl(), staticInitializer);
        realExtensionLoader = new ExtensionLoaderImpl(new ClassServiceLoader(), hiveMQExtensions,
                new HiveMQExtensionFactoryImpl(), staticInitializer);
    }
    ...
    public void test_load_from_empty_urls() {
        final Optional<Class<? extends ExtensionMain>> extensionMain = extensionLoader
                .loadFromUrls(new ArrayList<>(), "test-extension");
    ...
    public void test_classloader_loads_urls() throws Exception {
        ...
        final Optional<Class<? extends ExtensionMain>> loadedExtension = extensionLoader
                .loadFromUrls(Collections.singletonList(folder.toURI().toURL()), "test-extension");
    ...
    public void loadExtensions_folderDoesNotExist_permissive() throws Exception {
        final File extensionFolder = temporaryFolder.newFolder();
        assertTrue(extensionFolder.delete());
        final @NotNull ImmutableSet<HiveMQExtensionEvent> hiveMQExtensionEvents = extensionLoader
                .loadExtensions(extensionFolder.toPath(), true);
    ...
    public void test_load_extensions_from_empty_folder() throws Exception {
        final File extensionFolder = temporaryFolder.newFolder();
        final Collection<HiveMQExtensionEvent> extensions = extensionLoader
                .loadExtensions(extensionFolder.toPath(), false);
    ...
    public void test_load_extensions_folder_contain_wrong_id_in_xml_disabling_failed() throws Exception {
        ...
        final @NotNull ImmutableSet<HiveMQExtensionEvent> extensionEvents = extensionLoader
                .loadExtensions(extensionsFolder.toPath(), false);
    ...
    public void test_process_single_extension_folder_and_extension_same_folder_other_id_disabled() throws Exception {
        ...
        hiveMQExtensions.addHiveMQExtension(
                new HiveMQExtensionImpl(
                        ...
                        extensionFolder.toPath(), new TestExtensionMainImpl(), false));
        final HiveMQExtensionEvent event = extensionLoader.processSingleExtensionFolder(extensionFolder.toPath());
        assertNull(event);
        verify(classServiceLoader, never()).load(any(), any(ClassLoader.class));
    }
    ...
    public void test_process_single_extension_folder_and_extension_other_folder_same_id_enabling() throws Exception {
        ...
        hiveMQExtensions.addHiveMQExtension(
                new HiveMQExtensionImpl(
                        new HiveMQExtensionEntity("extension1", "my_extension", "1.0.0", 1, 1, "author"),
                        extensionFolder1.toPath(), new TestExtensionMainImpl(), false));
    ...
    public void test_process_single_extension_folder_and_extension_other_folder_same_id_disabling() throws Exception {
        ...
        hiveMQExtensions.addHiveMQExtension(
                new HiveMQExtensionImpl(
                        new HiveMQExtensionEntity("extension1", "my_extension", "1.0.0", 1, 1, "author"),
                        extensionFolder1.toPath(), new TestExtensionMainImpl(), true));
        final File file = new File(extensionFolder2, "extension.jar");
        final JavaArchive javaArchive = ShrinkWrap.create(JavaArchive.class)
                .addAsServiceProviderAndClasses(ExtensionMain.class, TestExtensionMainImpl.class);
        FileUtils.writeStringToFile(
    ...
    public void test_load_single_extension_load_and_instantiate_enabled() throws Throwable {
        ...
        final Optional<HiveMQExtensionEntity> extensionEntityFromXML = HiveMQExtensionXMLReader
                .getExtensionEntityFromXML(extensionFolder.toPath(), true);
        assertTrue(extensionEntityFromXML.isPresent());
        final HiveMQExtension hiveMQExtension = realExtensionLoader
                .loadSingleExtension(extensionFolder.toPath(), extensionEntityFromXML.get());
