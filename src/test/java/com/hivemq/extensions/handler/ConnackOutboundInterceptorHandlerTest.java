...
public class ConnackOutboundInterceptorHandlerTest {
    ...
    public void test_null_interceptors() throws Exception {
        final ConnackOutboundInterceptorProvider interceptorProvider = IsolatedExtensionClassloaderUtil
                .loadInstance(temporaryFolder.getRoot().toPath(), TestNullOutboundInterceptor.class);
