...
public class PubrecInboundInterceptorHandlerTest {
    ...
    private PubrecInboundInterceptorHandler handler;
    ...
    public void setUp() throws Exception {
        ...
        handler = new PubrecInboundInterceptorHandler(configurationService, asyncer, hiveMQExtensions,
    ...
    public void test_modify() throws Exception {
        ...
        final PubrecInboundInterceptor interceptor = getInterceptor("TestModifyInboundInterceptor");
    ...
    public void test_timeout_failed() throws Exception {
        ...
        final PubrecInboundInterceptor interceptor = getInterceptor("TestTimeoutFailedInboundInterceptor");
        final List<PubrecInboundInterceptor> list = ImmutableList.of(interceptor);
    ...
    public void test_exception() throws Exception {
        ...
        final PubrecInboundInterceptor interceptor = getInterceptor("TestExceptionInboundInterceptor");
        final List<PubrecInboundInterceptor> list = ImmutableList.of(interceptor);
    ...
    @NotNull
    private PubrecInboundInterceptor getInterceptor(@NotNull final String name) throws Exception {

        final JavaArchive javaArchive = ShrinkWrap.create(JavaArchive.class)
                .addClass("com.hivemq.extensions.handler.PubrecInboundInterceptorHandlerTest$" + name);
        ...
        final Class<?> interceptorClass =
                cl.loadClass("com.hivemq.extensions.handler.PubrecInboundInterceptorHandlerTest$" + name);
