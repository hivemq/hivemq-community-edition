...
public class MqttConnackerTest {
    ...
    private final LogbackCapturingAppender logbackCapturingAppender = LogbackCapturingAppender.Factory
            .weaveInto(LoggerFactory.getLogger(MqttConnackerImpl.class));
