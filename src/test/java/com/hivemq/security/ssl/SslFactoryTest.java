...
public class SslFactoryTest {
    ...
    public void test_get_ssl_handler_default_config() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.NONE).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(12345).build();
    ...
    public void test_invalid_keystore() {
        final Tls tls = new Tls.Builder().withKeystorePath(RandomStringUtils.randomAlphabetic(32))
                .withKeystoreType("JKS").withKeystorePassword(RandomStringUtils.randomAlphabetic(32))
                .withPrivateKeyPassword(RandomStringUtils.randomAlphabetic(32)).withProtocols(new ArrayList<>())
                .withTruststorePath(RandomStringUtils.randomAlphabetic(32)).withTruststoreType("JKS")
    ...
    public void test_custom_cipher_suites() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.NONE).withCipherSuites(cipherSuites).withHandshakeTimeout(12345)
                .build();
        final SslContext sslContext = sslFactory.getSslContext(tls);
        final SslHandler sslHandler = sslFactory.getSslHandler(socketChannel, tls, sslContext);
    ...
    public void test_custom_protocols() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(protocols)
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.NONE).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(12345).build();
        final SslContext sslContext = sslFactory.getSslContext(tls);
    ...
    public void test_cert_auth_none() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                ...
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.NONE).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(10000).build();
        final SslContext sslContext = sslFactory.getSslContext(tls);
        final SslHandler sslHandler = sslFactory.getSslHandler(socketChannel, tls, sslContext);
    ...
    public void test_cert_auth_optional() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.OPTIONAL).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(10000).build();
        final SslContext sslContext = sslFactory.getSslContext(tls);
        final SslHandler sslHandler = sslFactory.getSslHandler(socketChannel, tls, sslContext);
        assertFalse(sslHandler.engine().getNeedClientAuth());
    ...
    public void test_cert_auth_required() throws Exception {
        ...
        final Tls tls = new Tls.Builder().withKeystorePath(keystorePath).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.REQUIRED).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(10000).build();
        final SslContext sslContext = sslFactory.getSslContext(tls);
        final SslHandler sslHandler = sslFactory.getSslHandler(socketChannel, tls, sslContext);
    ...
    public void test_ssl_context_store_different() throws Exception {
        ...
        final Tls tls1 = new Tls.Builder().withKeystorePath(keystorePath1).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath1).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.OPTIONAL).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(10000).build();
        ...
        final Tls tls2 = new Tls.Builder().withKeystorePath(keystorePath2).withKeystoreType("JKS")
                .withKeystorePassword("passwd1").withPrivateKeyPassword("passwd2").withProtocols(new ArrayList<>())
                .withTruststorePath(keystorePath2).withTruststoreType("JKS").withTruststorePassword("passwd1")
                .withClientAuthMode(Tls.ClientAuthMode.OPTIONAL).withCipherSuites(new ArrayList<>())
                .withHandshakeTimeout(10000).build();
    ...
    public void test_verify_on_bootstrap_unknown_ciphers() throws Exception {
        ...
        final String message = logCapture.getLastCapturedLog().getFormattedMessage();
        assertEquals(
                "Unknown cipher suites for TCP Listener with TLS at address 0 and port 0: [UNKNOWN_CIPHER]",
                message);
    }
    ...
    public void test_prefer_server_cipher_suites_can_be_changed() throws Exception {
        ...
        final Tls tls2 = new Tls.Builder().withKeystorePath(keystorePath2).withKeystoreType("JKS")
                ...
                .withPreferServerCipherSuites(!engineDefaultPreferServerCipherSuites).withHandshakeTimeout(10000)
                .build();
        final SslContext sslContext2 = sslFactory.getSslContext(tls2);
