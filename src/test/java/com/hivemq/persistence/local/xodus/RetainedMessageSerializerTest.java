...
public class RetainedMessageSerializerTest {

    @Test
    public void test_serializeKey() {
        final byte[] key = RetainedMessageSerializer.serializeKey("topic");
        assertArrayEquals("topic".getBytes(UTF_8), key);
    }

    @Test
    public void test_deserializeKey() {
        final String key = RetainedMessageSerializer.deserializeKey("topic".getBytes(UTF_8));
