...
public class RetainedMessageRocksDBLocalPersistenceTest {
    ...
    public void setUp() throws Exception {
        ...
        persistence = new RetainedMessageRocksDBLocalPersistence(localPersistenceFileUtil, payloadPersistence,
                persistenceStartup);
        persistence.start();
    }
    ...
    public void test_persist_get_no_payload_found() {
        persistence.put(
                ...
                "topic/0",
                BucketUtils.getBucket("topic/0", BUCKETSIZE));
    ...
    public void test_persist_same_topic() {
        ...
        persistence.put(
                new RetainedMessage(new byte[0], QoS.AT_MOST_ONCE, 3L, MqttConfigurationDefaults.TTL_DISABLED),
                "topic",
                BucketUtils.getBucket("topic", BUCKETSIZE));
        assertEquals(
                "message3",
                new String(persistence.get("topic", BucketUtils.getBucket("topic", BUCKETSIZE)).getMessage()));
        persistence.put(
                new RetainedMessage(new byte[0], QoS.AT_MOST_ONCE, 4L, MqttConfigurationDefaults.TTL_DISABLED),
                "topic",
                BucketUtils.getBucket("topic", BUCKETSIZE));
        assertEquals(
                "message4",
    ...
    public void test_clean_up_expiry() {
        persistence.put(
                new RetainedMessage(new byte[0], QoS.AT_MOST_ONCE, 1L, 1, Mqtt5UserProperties.NO_USER_PROPERTIES, null,
                        null, null, null, System.currentTimeMillis() - 2000),
                "topic",
                0);
        persistence.put(
    ...
    public void getAllRetainedMessagesChunk_emptyPersistence() {
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk = persistence
                .getAllRetainedMessagesChunk(1, null, 100);
    ...
    public void getAllRetainedMessagesChunk_partOfAPersistence() {
        ...
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk1 = persistence
                .getAllRetainedMessagesChunk(1, null, 1);
        ...
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk2 = persistence
                .getAllRetainedMessagesChunk(1, chunk1.getLastKey(), 1);
    ...
    public void getAllRetainedMessagesChunk_everyThingInPersistence() {
        ...
        persistence.put(new RetainedMessage(new byte[0], QoS.AT_MOST_ONCE, 2L, 1000), "topic/2", 1);
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk = persistence
                .getAllRetainedMessagesChunk(1, null, Integer.MAX_VALUE);
        assertEquals(1, chunk.getBucketIndex());
    ...
    public void getAllRetainedMessagesChunk_removeDuringIteration() {
        ...
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk1 = persistence
                .getAllRetainedMessagesChunk(1, null, maxMemory);
        assertEquals(2, chunk1.getValue().size());
        persistence.remove(chunk1.getLastKey(), 1);
        final BucketChunkResult<Map<String, @NotNull RetainedMessage>> chunk2 = persistence
                .getAllRetainedMessagesChunk(1, chunk1.getLastKey(), maxMemory);
        assertEquals(1, chunk2.getValue().size());
        assertTrue(chunk2.isFinished());
    }
}
