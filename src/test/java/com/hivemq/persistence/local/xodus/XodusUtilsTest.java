...
public class XodusUtilsTest {
    ...
    public void test_byteiterable_to_string_conversion() {
        final String[] input = new String[]{"string", RandomStringUtils.randomAlphabetic(65535), "Я Б Г Д Ж Й",
                "Ł Ą Ż Ę Ć Ń Ś Ź", "てすと", "ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃ ", "０１２３４５６７８９", "ａｂｃｄｅｆｇｈｉ", "ＡＢＣＤＥＦＧＨＩ",
                "Iñtërnâtiônàlizætiøn", "⡍⠜⠇⠑⠹ ⠺⠁⠎ ⠙⠑⠁⠙⠒ ⠞⠕ ⠃⠑⠛⠔ ⠺⠊⠹⠲ ⡹⠻⠑ ⠊⠎ ⠝⠕ ⠙⠳⠃⠞", "i ♥ u",
                "\uD843\uDED7 \uD843\uDEF9 \uD843\uDEFA \uD843\uDF2D",
                "\uD843\uDF2E \uD843\uDF4C \uD843\uDFB4 \uD843\uDFBC \uD843\uDFEA \uD844\uDC5C", "ვეპხის ტყაოსანი",
                "ฉันกินกระจกไ", "Կրնամ", "सकता", "\uD834\uDE00\uD834\uDE10", "\uD83D\uDE1A", "\uD83D\uDEAA",
                "\uD83C\uDD84", "\uD80C\uDCE6", "\uD804\uDD3D", "\uDB40\uDC50", "\uDB40\uDFFC", "\uD83E\uDE13",
                "\uD800\uDF17"};
