...
image:https://maven-badges.sml.io/maven-central/com.hivemq/hivemq-community-edition-embedded/badge.svg["Maven Central",link="https://maven-badges.sml.io/sonatype-central/com.hivemq/hivemq-community-edition-embedded"]
image:https://img.shields.io/jitpack/version/com.github.hivemq/hivemq-community-edition["JitPack",link="https://jitpack.io/#hivemq/hivemq-community-edition"]
...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2026.5/hivemq-ce-2026.5.zip[HiveMQ CE binary package].
* Unzip the package.
...
For further development instructions see the link:CONTRIBUTING.md[contribution guidelines].
...
NOTE: An EmbeddedHiveMQ is a resource that is similar to an e.g. network connection and implements the `java.lang.AutoCloseable` interface.
...
++++
<img alt="" referrerpolicy="no-referrer-when-downgrade" src="https://static.scarf.sh/a.png?x-pxid=39c2b98a-0d1a-4a1c-8ce2-1cce4d0fbcf1&page=README.adoc" />
++++

== Contributing

If you want to contribute to HiveMQ CE, see the link:CONTRIBUTING.md[contribution guidelines].
