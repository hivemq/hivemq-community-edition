...
IMPORTANT: Until HiveMQ Community Edition 2020.3 is released embedded mode is only available from link:https://jitpack.io/#hivemq/hivemq-community-edition-embedded[jitpack.io].
...
dependencies {
    implementation 'com.github.hivemq:hivemq-community-edition-embedded:master-SNAPSHOT'
}
----
...
<project>
    ...
    <dependencies>
	    <dependency>
	        <groupId>com.github.hivemq</groupId>
