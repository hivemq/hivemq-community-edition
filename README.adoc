...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2025.5/hivemq-ce-2025.5.zip[HiveMQ CE binary package].
* Unzip the package.
...
<img referrerpolicy="no-referrer-when-downgrade" src="https://static.scarf.sh/a.png?x-pxid=39c2b98a-0d1a-4a1c-8ce2-1cce4d0fbcf1&page=README.adoc" />
