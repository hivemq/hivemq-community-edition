...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2026.6/hivemq-ce-2026.6.zip[HiveMQ CE binary package].
* Unzip the package.
...
dependencies {
    implementation("com.hivemq:hivemq-community-edition-embedded:2026.6")
}
----
