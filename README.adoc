...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2023.5/hivemq-ce-2023.5.zip[HiveMQ CE binary package].
* Unzip the package.
...
dependencies {
    implementation("com.hivemq:hivemq-community-edition-embedded:2023.5")
}
----
