...
image:https://img.shields.io/github/actions/workflow/status/hivemq/hivemq-community-edition/check.yml?branch=master[GitHub Workflow Status (with branch)]
...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2023.1/hivemq-ce-2023.1.zip[HiveMQ CE binary package].
* Unzip the package.
...
dependencies {
    implementation("com.hivemq:hivemq-community-edition-embedded:2023.1")
}
----
