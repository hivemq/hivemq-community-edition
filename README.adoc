...
image:https://github.com/hivemq/hivemq-community-edition/actions/workflows/check.yml/badge.svg?branch=master["Build Status", link=https://github.com/hivemq/hivemq-community-edition/actions/workflows/check.yml?query=branch%3Amaster]
