...
* Download the latest https://github.com/hivemq/hivemq-community-edition/releases/download/2024.9/hivemq-ce-2024.9.zip[HiveMQ CE binary package].
* Unzip the package.
...
dependencies {
    implementation("com.hivemq:hivemq-community-edition-embedded:2024.9")
}
----
